 ...
 */
public class CloudFilterHeaderSkin extends Border
{
...
*/	
	 ...
	 *  Constructor.
	 */
	public function CloudFilterHeaderSkin()
	{
		super();
	}
...
/*				
				...
				g.moveTo(0, h+1);
				g.lineTo(200, h+1);
				//g.beginFill(0xD0D0D0, 0.5);
				//g.drawRect(-1,0, 160, h);
				//g.endFill();


				g.lineStyle(); // Reset LineStyle
*/				
